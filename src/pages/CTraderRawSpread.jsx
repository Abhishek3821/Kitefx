  ...
  return (
    <div>
      <Banner
        ...
        description="cTrader was built for demanding performances and, when combined with KiteFX Global Raw pricing and unrivalled execution speeds, cTrader makes a valuable addition to your trading arsenal and will help take your trading to the next level."
