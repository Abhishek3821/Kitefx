...
export default function Indices() {
  return (
    <div>
      <Banner
        title="Indices "
        description="The KiteFX  Global Indices offering is one of the most competitive in the world. Access the world’s largest and most liquid market with Raw spreads starting from 0.0 pips. "
