  ...
  return (
    <div>
      <Banner
        ...
        buttonText="Install cTrader for iPhone/iPad"
        onButtonClick={() => console.log("CTA clicked")}
        backgroundImage={assets.kitefx20}
      />
      <Tabs tabs={tabs} />
      <TradingPlatformHero
        title="Trade on the most sophisticated trading technology IC Markets cTrader iOS"
        description={
          <>
            <span>
              IC Markets Global cTrader for iPhone gives you the very best in FX
              trading as a native app. Gain access to our tight spreads and fast
              execution speeds directly from your iOS device. You will get the
              same core functionality as cTrader Web for Mobiles, with faster
              launch times and the same easy-to-use interface.
            </span>
            <br />
            <br />
            <span>
              This portable version of cTrader can be accessed from any iOS
              device, so you’re never more than a touch away from the world’s
              most liquid market.
            </span>
            <br />
            <br />
            <span>
              cTrader for iOS gives you all the tools you will need for
              effective technical analysis, including common trend indicators,
              oscillators, volatility measures and line drawings, all accessible
              from directly within the chart.
            </span>
          </>
        }
        ctaText="Use cTrader iOS"
...
export default CTraderIphoneIpad;
