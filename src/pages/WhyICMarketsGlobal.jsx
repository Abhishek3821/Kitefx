...
export default function Quickstart() {
  return (
    <div>
      <Banner
        title="Why Choose KiteFX  Global"
        description="KiteFX Global has grown to become one of the largest MetaTrader 4 Forex CFD providers in the world by giving traders what they really want."
