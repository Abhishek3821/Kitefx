    ...
    <section className="w-full bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-20 space-y-20">
        ...
        <InfoBlock
          ...
          text="IC Markets Global is built around traders’ needs. Our experienced support team understands the forex market and provides reliable assistance whenever you need it. Trade with confidence knowing help is available 24 hours a day, 7 days a week."
        />
        ...
        <InfoBlock
          ...
          text="Trade on MetaTrader 4, MetaTrader 5, cTrader, and TradingView—industry-leading platforms trusted by traders worldwide. IC Markets Global delivers Raw Pricing access across all supported platforms."
        />
        ...
        <InfoBlock
          ...
          text="IC Markets Global is regulated by the Financial Services Authority of Seychelles (FSA). Client funds are securely held in segregated accounts with top-tier international banks and are never used for operational purposes."
        />
