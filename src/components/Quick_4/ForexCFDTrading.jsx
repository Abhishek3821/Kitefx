        ...
        <div className="bg-white rounded-3xl p-10 lg:p-6 grid grid-cols-1 lg:grid-cols-3 gap-14 shadow-sm">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl">
              IC Markets Global MetaTrader 4/5 and cTrader/TradingView accounts
              allow you to trade over <span className="font-medium">60+ currency pairs</span>{" "}
              including majors, minors and exotics with the tightest possible
              spreads through Raw Pricing connectivity. Trade with flexible
              leverage from <span className="font-medium">1:1 to 1:1000</span>{" "}
