        ...
        <div className="relative bg-white rounded-3xl p-10 lg:p-6 grid grid-cols-1 lg:grid-cols-3 gap-14 shadow-sm">
          ...
          <div className="lg:col-span-2 space-y-7">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-3xl">
              KiteFX Global allows you to select an account type that suits you
              best. Choose from our Standard MetaTrader 4/5 account with no
              commissions and a minimum spread of{" "}
              <span className="font-medium">0.08 pip</span>, our Raw Spread
              MetaTrader 4/5 account with spreads from{" "}
              <span className="font-medium">0.0 pips</span>, or our cTrader Raw
              Spread account with spreads as low as{" "}
              <span className="font-medium">0.0</span>. All platforms benefit
              from our ultra-low latency trading environment.
            </p>
          </div>
