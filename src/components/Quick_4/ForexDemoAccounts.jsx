        ...
        <div className="bg-white rounded-3xl p-2 lg:p-6 grid grid-cols-1 lg:grid-cols-3 gap-14 shadow-sm">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl">
              KiteFX Global MetaTrader 4/5 and cTrader demo accounts allow
              ...
              features as our live trading accounts, including ultra-low latency
              execution and our world-renowned Raw Spread pricing connectivity
              with no requotes.
            </p>

            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-4xl">
              Foreign exchange traders can practice placing trades and test
              their expert advisors (EAs) before making the transition to a live
              trading environment.
            </p>
          </div>
        </div>
