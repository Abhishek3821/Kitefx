  ...
  return (
    <section className="w-full bg-white py-28">
      <div className="max-w-5xl mx-auto px-4 text-center">
        ...
        >
          The IC Markets Global MetaTrader 4 and 5 servers are located in the
          Equinix NY4 data centre in New York. The NY4 data centre referred to as
          a financial ecosystem is home to over 600 buy and sell side firms,
          exchanges, trading venues, market data and service providers. The
          MetaTrader 4 and 5 servers are cross connected to our network to ensure
        ...
        >
          The IC Markets Global MetaTrader 4 and 5 trade servers have latency on
